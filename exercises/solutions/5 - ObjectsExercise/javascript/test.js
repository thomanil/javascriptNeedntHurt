...
YAHOO.tool.TestRunner.add(new YAHOO.tool.TestCase({
    ...
    name: "Object Exercise TestCase",

    testCallInnerObjectBarFunction : function () {
		this.assert.areEqual(55, ObjectsExercise.InnerObject.getFoo());
    },

	testEvalJSONAndCallResultingObject : function() {
		var JSONString = "{\"firstName\":\"John\",\"lastName\":\"Smith\",\"gender\":\"Male\"}";
		var JSONObject = ObjectsExercise.turnJSONStringIntoObject(JSONString);		
		var expectedLastName = JSONObject.lastName;
		this.assert.areEqual("Smith", expectedLastName);
	}
