...
YAHOO.tool.TestRunner.add(new YAHOO.tool.TestCase({
    ...
    testSubtract : function () {
        this.assert.areEqual(2, UnitTestExercise.subtractNumbers(6,4));
    },

    testMultiply : function () {
        this.assert.areEqual(12, UnitTestExercise.multiplyNumbers(3,4));
    },

    testDivide : function () {
        this.assert.areEqual(3, UnitTestExercise.divideNumbers(15,5));
    }
