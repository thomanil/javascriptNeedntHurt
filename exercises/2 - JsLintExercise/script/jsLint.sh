...
echo "Running jsLint on: javascript/JsLintExercise.js"
java -classpath ../lib/jsLint/js.jar org.mozilla.javascript.tools.shell.Main ../lib/jsLint/jslint.js ../javascript/JsLintExercise.js
