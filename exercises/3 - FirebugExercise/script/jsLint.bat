...
ECHO.
ECHO Running jsLint on: javascript/FirebugExercise.js
ECHO.

java -classpath ../lib/jsLint/js.jar org.mozilla.javascript.tools.shell.Main ../lib/jsLint/jslint.js ../javascript/FirebugExercise.js
