...
echo "Running jsLint on: javascript/UnobtrusiveExercise.js"
java -classpath ../lib/jsLint/js.jar org.mozilla.javascript.tools.shell.Main ../lib/jsLint/jslint.js ../javascript/UnobtrusiveExercise.js
